...
namespace OxidCommunity\DevutilsLogs\Controller;
...
class StartController extends StartController_parent {
    public function bratMirEinenStorch() {
        ...
        if (!file_exists($sExLog)) $response["exceptions"]["status"] = "ERROR: oxideshop.log does not exist";
        elseif (!is_readable($sExLog)) $response["exceptions"]["status"] = "ERROR: oxideshop.log is not readable";
        else {
